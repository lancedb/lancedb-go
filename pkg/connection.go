...
//
//nolint:gocritic
func Connect(_ context.Context, uri string, options *ConnectionOptions) (*Connection, error) {
...
//
//nolint:gocritic
func (c *Connection) OpenTable(_ context.Context, name string) (*Table, error) {
	c.mu.RLock()
	defer c.mu.RUnlock()
