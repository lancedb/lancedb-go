...
import (
	...
	"github.com/lancedb/lancedb-go/pkg"
	"log"
	"os"
)
...
func main() {
	...
	indexesToCreate := []struct {
	...
	}{
		{
			name:        "BTree Index",
			columns:     []string{"id"},
			indexType:   lancedb.IndexTypeBTree,
		...
		},
		{
			...
			indexType:   lancedb.IndexTypeBitmap,
		...
		},
		{
			name:        "FTS Index",
			columns:     []string{"name"},
			indexType:   lancedb.IndexTypeFts,
		...
		},
		{
			...
			columns:     []string{"embedding"},
			indexType:   lancedb.IndexTypeIvfFlat,
		...
		},
		{
			...
			columns:     []string{"embedding"},
			indexType:   lancedb.IndexTypeHnswPq,
